...
def _sample_deals() -> list[Deal]:
    return [
        Deal(
            ...
            # Live competitive picture: a cheaper copy exists (best_alt beats) → the
            # oxblood "Best price" card + the rest-of-field ladder (one below-floor).
            market_authoritative=True, is_cheapest=False,
            market_total=6, market_low=44.0, market_high=98.0,
            market_copies=[
                {"listing_id": 58, "effective_cost": 58.0, "currency": "EUR",
                 "media_condition": "Very Good Plus (VG+)", "sleeve_condition": "Very Good Plus (VG+)",
                 "seller_username": "discland", "listing_url": "https://x/58", "below_floor": False},
                {"listing_id": 61, "effective_cost": 61.0, "currency": "EUR",
                 "media_condition": "Near Mint (NM or M-)", "sleeve_condition": "Very Good Plus (VG+)",
                 "seller_username": "jazzcat", "listing_url": "https://x/61", "below_floor": False},
                {"listing_id": 40, "effective_cost": 40.0, "currency": "EUR",
                 "media_condition": "Very Good (VG)", "sleeve_condition": "Very Good (VG)",
                 "seller_username": "bargainbin", "listing_url": "https://x/40", "below_floor": True},
            ],
            best_alt=Deal(
                id=99, release_artist="Miles Davis", release_title="Kind of Blue",
                release_year=1959, release_format="LP", release_country="US",
                media_condition="Near Mint (NM or M-)", sleeve_condition="Near Mint (NM or M-)",
                buyer_price=44.0, buyer_currency="EUR", shipping_buyer_price=0.0,
                landed_price=44.0, landed_currency="EUR", effective_cost=44.0,
                discount_pct=54, effective_discount=0.54, ranked=True,
                deal_source="below_sold_median", median_value=95.0, median_currency="EUR",
                sold_median_value=95.0, sold_median_currency="EUR", sold_data_points=8,
                sold_low_value=38.0, sold_high_value=160.0, sold_last_date="2026-02-15",
                seller_username="crateking", seller_rating=99.8,
                ships_from="Netherlands", shipping_region="Netherlands",
                comments="Archival storage, never played since grading.",
                listing_url="https://www.discogs.com/sell/item/99",
                shipping_hint={"seller": "crateking", "currency": "EUR", "country": "NL",
                               "free_shipping": True, "free_min": 60.0, "subtotal": 44.0,
                               "free_gap": 16.0, "tiers": [[2, 4.0], [0, 7.0]], "per_item": 1},
                seller_picks=[{"buyer_price": 15.0, "buyer_currency": "EUR",
                               "media_condition": "Very Good Plus (VG+)",
                               "release_artist": "Sonny Clark", "release_title": "Cool Struttin'",
                               "listing_url": "https://www.discogs.com/sell/item/201",
                               "discount_pct": 38}],
                seller_total_others=4,
            ),
        ),
        Deal(
            ...
            # Live competitive picture: you're already the cheapest → neutral "Next
            # best" runner-up card (a better grade for more money) + the ✓ chip.
            market_authoritative=True, is_cheapest=True,
            market_total=3, market_low=39.0, market_high=70.0,
            market_copies=[
                {"listing_id": 70, "effective_cost": 70.0, "currency": "EUR",
                 "media_condition": "Near Mint (NM or M-)", "sleeve_condition": "Near Mint (NM or M-)",
                 "seller_username": "idmvault", "listing_url": "https://x/70", "below_floor": False},
            ],
            best_alt=Deal(
                id=88, release_artist="Aphex Twin",
                release_title="Selected Ambient Works 85–92",
                release_year=1994, release_format="2×LP", release_country="UK",
                media_condition="Near Mint (NM or M-)", sleeve_condition="Near Mint (NM or M-)",
                buyer_price=45.0, buyer_currency="EUR", shipping_buyer_price=7.0,
                landed_price=52.0, landed_currency="EUR", effective_cost=52.0,
                discount_pct=8, effective_discount=0.08, ranked=True,
                deal_source="below_sold_median", median_value=50.0, median_currency="EUR",
                sold_median_value=50.0, sold_median_currency="EUR", sold_data_points=14,
                sold_low_value=15.0, sold_high_value=120.0, sold_last_date="2026-02-10",
                seller_username="idmvault", seller_rating=99.2, ships_from="Germany",
                shipping_region="Germany", listing_url="https://x/88",
            ),
        ),
        Deal(
