...
annotations the orchestrator layers on (Discogs-wide median, all-time-low floor,
sibling listings, per-seller shipping hint).
...
class Deal(Listing):
    ...
    discogs_wide_median_value: float | None = None
    discogs_wide_median_currency: str | None = None
